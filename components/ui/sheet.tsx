...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="flex items-center absolute right-4 top-7 rounded-sm opacity-70 text-slate-950 dark:text-white
       ring-offset-white transition-opacity hover:opacity-100 focus:outline-none 
       focus:ring-0 focus:ring-slate-950 focus:ring-offset-0 disabled:pointer-events-none data-[state=open]:bg-slate-100
